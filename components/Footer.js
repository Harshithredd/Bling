...
const Footer = () => {
  return (
<footer className="text-cyan-600 body-font  bg-gradient-to-r from-yellow-600  via-yellow-500  to-yellow-300">
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-50">First Link</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-50">Second Link</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-50">Third Link</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-50">Fourth Link</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
