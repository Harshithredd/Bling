  ...
  <section className="text-gray-400 bg-gray-900 body-font">
    <div className="container px-5 py-24 mx-auto">
      <div className="flex flex-wrap -m-4 justify-center">
        <div className="lg:w-1/5 md:w-1/2 p-4 w-full lg:m-5">
          <Link href='product/slug'>
            <a className="block relative rounded overflow-hidden">
              <img alt="ecommerce" className="h-[36vh] m-auto md:h-[36vh] block" src="https://assets.ajio.com/medias/sys_master/root/20220927/BBTe/63320310f997dd1f8d1e179f/-473Wx593H-410327227-001-MODEL.jpg"/>
            </a>
